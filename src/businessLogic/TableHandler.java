...
public class TableHandler {
    ...
    public static void reiceveBet(Table round) throws Exception {
     ...
     * @param round
     */
    public static void playRound(Table round) {
     ...
     * @param round
     */
    public static void compareHands(Table round) {
     ...
     *
     */
    public static void checkTies(Table round) {
        int x = 0;
