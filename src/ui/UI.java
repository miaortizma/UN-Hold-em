...
public class UI {
    ...
    public static void printBoard(int pos, String[] jugadores) {
        ...
        System.out.println("  #############################################  ");
        System.out.println(" #        " + jugadores[0] + "         " + jugadores[1] + "         " + jugadores[2] + "       # ");
        System.out.println("#          " + botones[0] + "            " + botones[1] + "            " + botones[2] + "         # ");
        System.out.println("#" + jugadores[7] + "  " + botones[7] + "        " + "10\u2666 10\u2764 10\u2663 J\u2660 J\u2663" + "      " + botones[3] + "  " + jugadores[3] + "# ");
        System.out.println("#          " + botones[6] + "            " + botones[5] + "            " + botones[4] + "         #");
        System.out.println(" #        " + jugadores[6] + "         " + jugadores[5] + "         " + jugadores[4] + "       # ");
        System.out.println("  #############################################  ");
    }
}
